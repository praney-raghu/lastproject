...
function init_DataTables() {
    ...
    "undefined" != typeof $.fn.DataTable) {
        ...
        var a = function() {
            let c =  $("#datatable-buttons").DataTable({
                columnDefs: [ {
                    orderable: false,
            ...
            c.on("click", "th.select-checkbox", function() {
            ...
            if (typeof window.route_mass_crud_entries_destroy != 'undefined') {
                $('.datatable').siblings('.actions').html('<a href="' + window.route_mass_crud_entries_destroy + '" class="btn btn-xs btn-danger js-delete-selected" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
            }
        ...
        b.on("draw.dt", function()  { $('input[type=checkbox]').iCheck({ checkboxClass: 'icheckbox_flat-green' }); });
